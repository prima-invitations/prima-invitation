document.querySelector('.registration-form').addEventListener('submit', function (event) {
  ...
  fetch(
    'https://script.google.com/macros/s/AKfycbxjQdIZ5TJrOHug0XVvubPvUW5485SOuAOjwWs0RcEvN0OCjsiMurP_yI3SC5-5lW9KcA/exec',
    {
      method: 'POST',
      body: formData,
    },
    ...
    .then((data) => {
      ...
      if (data.result === 'success') {
        window.location.href = 'https://t.me/+3gqY-ObhxFZiOTMy';
      } else {

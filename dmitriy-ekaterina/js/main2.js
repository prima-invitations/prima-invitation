...
document.querySelector('.registration-form').addEventListener('submit', function (event) {
  ...
  fetch(
    'https://script.google.com/macros/s/AKfycbz4poN9qgOhi30fHZihgbKDa2OGIyChr5NLVgw0u7r9KSBfXGlTamefLp5xO6--xewy/exec',
    {
      method: 'POST',
      body: formData,
    },
    ...
    .then((data) => {
      ...
      if (data.result === 'success') {
        window.location.href = 'https://prima-invitations.vercel.app/dmitriy-ekaterina/thanks.html';
      } else {
